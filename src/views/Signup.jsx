...
export default function SignUp() {
  ...
  async function onSubmit(e) {
    ...
    try {
      axiosClient.post("/register",formDataCopy).then(({data})=>{
        setUser(data.user);
        setToken(data.token);
      })
      ...
      //toast.error("Something went wrong, user couldn't be registered");
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <div className=" flex justify-between  whitespace-nowrap text-sm sm:text-lg">
                <p className="mb-4 text-white font-semibold mr-5">
                  {" "}
